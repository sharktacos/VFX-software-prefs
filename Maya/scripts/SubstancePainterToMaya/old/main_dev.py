...
def proceed(ui, foundTextures, renderer, uiElements):
    ...
    for texture in texturesToUse:
        ...
        layer_material = render_helper.connect(ui, texture, renderer, fileNode)

#        if layer_material and useLyr and texture.materialAttribute == mixNode:
#            print('main ' + layer_material)

#            render_helper.createLayerNetwork(texture, renderer, fileNode, layer_material)
...
#            render_helper.createLayerNetwork(texture, renderer, render_helper.layer_material)
